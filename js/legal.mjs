...
const gotoPrivacy = () => {
  history.pushState({}, 'Coniestica - Misión de la empresa', getPathName() + '?v=privacy');
  titleEl.innerHTML = 'Términos de privacidad';
  textEl.innerHTML = LEGAL_PRIVACY;
}

const gotoTerms = () => {
  history.pushState({}, 'Coniestica - Visión de la empresa', getPathName() + '?v=terms_and_conditions');
