...
const gotoMission = () => {
  history.pushState({}, 'Coniestica - Misión de la empresa', getPathName() + '?v=mission');
  cardsParentEl.innerHTML = COMPANY_MISSION_CARD_HTML;
}

const gotoVision = () => {
  history.pushState({}, 'Coniestica - Visión de la empresa', getPathName() + '?v=vision');
  cardsParentEl.innerHTML = COMPANY_VISION_CARD_HTML;
}

const gotoObjectives = () => {
  history.pushState({}, 'Coniestica - Objetivos de la empresa', getPathName() + '?v=objectives');
